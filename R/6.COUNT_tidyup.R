...
noexpression_50 <- rowMeans(matrix0[, 2:ncol(matrix0)] == 0 ) >=0.5
matrix_filtered <- matrix0[!noexpression_80,]
matrix_filtered_50 <- matrix0[!noexpression_50,]
#这里写好经处理的原始数据
write.csv(matrix_filtered,'Results/RawCOUNT.csv',row.names = TRUE)
